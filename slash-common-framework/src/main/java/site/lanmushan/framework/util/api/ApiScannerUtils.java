...
public class ApiScannerUtils {
    ...
    public static List<ControllerApiInfo> initApiList() {
        String contextPath=((WebApplicationContext)ApplicationUtil.getApplication()).getServletContext().getContextPath();
        ...
        for (Object object : objects) {
            resolveApis(contextPath,object, allApiInfo);
        }
        return allApiInfo;
    }

    private static void resolveApis(String contextPath,Object ob, List<ControllerApiInfo> apiInfos) {
        ...
        for (Method method : methods) {
            ...
            apiInfo.setApiUrl(contextPath+apiStr);
            apiInfo.setGroupName(groupName);
